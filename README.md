...
1. **装完自动打招呼**，问你对什么感兴趣
2. **冷启动三连探索**（15秒/4分钟/8分钟各出发一次），快速产出前 3 张明信片
3. **每天 4 次定时探索**（9:00 / 12:00 / 15:00 / 20:00），持续发现新内容
4. **明信片推送**到你的聊天窗口——有标题、有观点、有原文链接
5. **兴趣图谱自动演化**——聊天中提到的新兴趣会被捕获，探索方向逐渐个性化
6. **深潜模式**——每周六 22:00 深度探索，或用户说"深潜"主动触发
7. **周度总结**——每周日 10:00 自动推送过去 7 天的明信片回顾
8. **随机翻牌**——说"随机"或"随便看看"，从已收到的明信片中随机推送
9. **搜索历史**——说"搜索"+关键词，在明信片历史中搜索
10. **分享功能**——说"分享"生成可发社交媒体的文案
